 ...
 *@author: ----
 *@param {string} token. REST API token for yandex disk with the read-only permission.
 */
function establish_player(token){
...
/**
 *Launches the boot sequence.
 */
establish_player(token);
